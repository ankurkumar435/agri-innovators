...
const translations = {
  ...
  mr: {
    ...
    // Auth extras
    signUp: "साइन अप",
    joinCommunity: "आमच्या AI-चालित शेती समुदायात सामील व्हा",
    firstName: "पहिले नाव",
    lastName: "आडनाव",
    verifyEmail: "तुमचा ईमेल सत्यापित करा",
    enterOtpSent: "ईमेलवर पाठवलेला 6-अंकी कोड प्रविष्ट करा",
    ...
    enterPhone10: "तुमचा 10-अंकी फोन नंबर प्रविष्ट करा",
    enterStrongPassword: "एक मजबूत पासवर्ड प्रविष्ट करा",
    ...
    invalidPhoneDesc: "कृपया वैध 10-अंकी फोन नंबर प्रविष्ट करा.",
    invalidOtp: "अवैध OTP",
    invalidOtpDesc: "कृपया 6-अंकी कोड प्रविष्ट करा.",
    otpSent: "OTP पाठवला!",
    otpSentDesc: "कृपया सत्यापन कोडसाठी तुमचा ईमेल तपासा.",
    otpResent: "OTP पुन्हा पाठवला!",
    otpResentDesc: "नवीन कोडसाठी तुमचा ईमेल तपासा.",
    accountVerified: "खाते सत्यापित!",
    welcomeSmartFarming: "स्मार्ट शेतीमध्ये तुमचे स्वागत आहे.",
    welcomeBack: "परत आल्याबद्दल स्वागत आहे!",
    registrationFailed: "नोंदणी अयशस्वी",
    verificationFailed: "सत्यापन अयशस्वी",
    resendFailedTitle: "पुन्हा पाठवणे अयशस्वी",
    loginFailed: "लॉगिन अयशस्वी",
    resetLinkSent: "रीसेट लिंक पाठवली!",
    resetLinkSentDesc: "पासवर्ड रीसेट लिंकसाठी तुमचा ईमेल तपासा.",
    resetLinkFailed: "रीसेट लिंक पाठवण्यात अयशस्वी",
    enterEmailFirst: "तुमचा ईमेल प्रविष्ट करा",
    enterEmailFirstDesc: "कृपया प्रथम तुमचा ईमेल पत्ता प्रविष्ट करा.",

    // About
    aboutSmartFarm: "SmartFarm बद्दल",
    aboutTagline: "AI तंत्रज्ञानाने शेतीत क्रांती",
    ourMission: "आमचे ध्येय",
    missionText: "अत्याधुनिक AI तंत्रज्ञान आणि डेटा-चालित अंतर्दृष्टीसह जगभरातील शेतकऱ्यांना सक्षम करणे, त्यांना उत्पादकता वाढविण्यात, पर्यावरणीय प्रभाव कमी करण्यात आणि भावी पिढ्यांसाठी शाश्वत शेती पद्धती तयार करण्यात मदत करणे.",
    whatWeOffer: "आम्ही काय देतो",
    sustainableFarming: "शाश्वत शेती",
    sustainableDesc: "हिरव्या भविष्यासाठी पर्यावरण अनुकूल शेती पद्धतींना प्रोत्साहन.",
    increasedYield: "वाढलेले उत्पादन",
    increasedYieldDesc: "तुमचे पीक उत्पादन जास्तीत जास्त करण्यासाठी AI-चालित शिफारसी.",
    riskManagement: "जोखीम व्यवस्थापन",
    riskManagementDesc: "प्रगत हवामान निरीक्षण आणि कीड अंदाज प्रणाली.",
    ourImpact: "आमचा प्रभाव",
    farmersServed: "सेवा दिलेले शेतकरी",
    avgYieldIncrease: "सरासरी उत्पादन वाढ",
    countries: "देश",
    satisfactionRate: "समाधान दर",
    meetOurTeam: "आमच्या टीमला भेटा",
    recognition: "मान्यता",
    joinRevolution: "क्रांतीत सामील व्हा",
    joinRevolutionText: "AI-चालित अंतर्दृष्टीने तुमच्या शेती पद्धती बदलण्यास तयार आहात?",
    getStartedToday: "आजच सुरुवात करा",

    // Contact
    contactUsTitle: "संपर्क साधा",
    getInTouch: "आमच्या शेती तज्ज्ञांशी संपर्क साधा",
